...
const point_services_1 = require("./point.services");
    ...
    common_1.Module({
        imports: [
            microservices_1.ClientsModule.register([
                {
                    name: 'POINT_SERVICE', transport: microservices_1.Transport.RMQ,
                    options: {
                        urls: [`amqp://${environment_1.default.PointQueue.user}:${environment_1.default.PointQueue.password}@${environment_1.default.PointQueue.host}:${environment_1.default.PointQueue.port}/${environment_1.default.PointQueue.VHost}`],
                        queue: `${environment_1.default.PointQueue.queue}`,
                        queueOptions: {
                            durable: false,
                            arguments: {
