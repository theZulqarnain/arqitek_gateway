...
exports.PracticeInterceptor = void 0;
const common_1 = require("@nestjs/common");
const microservices_1 = require("@nestjs/microservices");
const environment_1 = require("../../config/environment");
const rxjs_1 = require("rxjs");
const operators_1 = require("rxjs/operators");
let PracticeInterceptor = class PracticeInterceptor {
    ...
    intercept(context, next) {
        try {
            ...
            const pattern = { cmd: "validateUserPractices" };
            if (req.headers['authorization'] && req.headers['product_code'] && path && method && req.headers['org_id']) {
                ...
                return this.UAM_SERVICE
                    ...
                    console.log(e, 'sdasdffsdf', e instanceof microservices_1.RpcException);
...
PracticeInterceptor = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject("UAM_SERVICE")),
    __metadata("design:paramtypes", [microservices_1.ClientProxy])
], PracticeInterceptor);
exports.PracticeInterceptor = PracticeInterceptor;
//# sourceMappingURL=practice.interceptor.js.map