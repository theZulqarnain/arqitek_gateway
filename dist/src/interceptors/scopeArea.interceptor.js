...
exports.ScopeAreaInterceptor = void 0;
const common_1 = require("@nestjs/common");
const microservices_1 = require("@nestjs/microservices");
const environment_1 = require("../../config/environment");
const rxjs_1 = require("rxjs");
const operators_1 = require("rxjs/operators");
let ScopeAreaInterceptor = class ScopeAreaInterceptor {
...
ScopeAreaInterceptor = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject("UAM_SERVICE")),
    __metadata("design:paramtypes", [microservices_1.ClientProxy])
], ScopeAreaInterceptor);
exports.ScopeAreaInterceptor = ScopeAreaInterceptor;
//# sourceMappingURL=scopeArea.interceptor.js.map